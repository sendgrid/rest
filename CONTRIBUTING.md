...
See the [examples folder](https://github.com/sendgrid/rest/tree/HEAD/examples) to get started quickly.
...
All test files are in [`rest-test.go`](https://github.com/sendgrid/rest/blob/HEAD/rest_test.go).

For the purposes of contributing to this repo, please update the [`rest-test.go`](https://github.com/sendgrid/rest/blob/HEAD/rest_test.go) file with unit tests as you modify the code.
